from opc.utils.features import atom_to_feature_vector, bond_to_feature_vector
...
def smiles2graph(smiles_string, removeHs=True, reorder_atoms=False, add_fp=False):
    """
